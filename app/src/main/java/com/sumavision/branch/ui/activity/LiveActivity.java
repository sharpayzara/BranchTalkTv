...
public class LiveActivity extends BaseActivity<ProgramDetailPresenter> implements TracksFragment.ITrackHolder,IProgranDetailView {
    ...
    public static Intent newIntent(Context context, String sourceUrl,boolean isCrack) {
        Intent intent = new Intent(context, LiveActivity.class);
        intent.putExtra("sourceUrl", sourceUrl);
        intent.putExtra("isCrack", isCrack);
        return intent;
    }

    public static void intentTo(Context context, String sourceUrl,boolean isCrack) {
        context.startActivity(newIntent(context, sourceUrl,isCrack));
    }
    ...
    public void initView() {
        ...
        isCrack =intent.getBooleanExtra("isCrack",true);
        ...
        if (isCrack){
            presenter.crackUrl(sourceUrl,2);
        }else{
